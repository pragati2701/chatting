        ...
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
            ...
            <div class="col-lg-6">
                <h1 class="display-5 fw-bold lh-1 mb-3">
                    Pro's <span class="text-primary">ChatX</span>
                </h1>
                <p class="lead">
                   Pro's ChatX is a simple chat application that allows you to chat with your friends and family in
                    real time.
                </p>
